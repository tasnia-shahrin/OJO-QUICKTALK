    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (currentUser != null) {
            ...
            if (ChatsRef != null && UsersRef != null) {
                ...
                // Continue with your FirebaseRecyclerAdapter setup
            } else {
                // Handle the case where the database references are null, e.g., show an error message.
            }
        } else {
            // Handle the case where the user is not authenticated, e.g., redirect to the login screen.
        }
